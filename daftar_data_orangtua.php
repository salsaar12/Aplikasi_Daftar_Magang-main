                    ...
                    <div class="card-content">
                        <form method="post" action="daftar_data_orangtua.php">
                            ...
                            <fieldset class="the-fieldset">
                                <legend class="the-legend"><b>Data Ayah</b></legend>
                                ...
                                <!-- <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="text" class="form-control" name="birth_place_father" placeholder="Masukan Tempat Lahir..." value="<?php isset($_SESSION['birth_place_father'])  ?  print($_SESSION['birth_place_father']) : ""; ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group label-floating">
                            ...
                            <!-- <fieldset class="the-fieldset" style="margin-top: 20px">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="text" class="form-control" name="mother_name" placeholder="Masukan Nama Lengkap..." required value="<?php isset($_SESSION['mother_name'])  ?  print($_SESSION['mother_name']) : ""; ?>" autofocus>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="text" class="form-control" name="birth_place_mother" placeholder="Masukan Tempat Lahir..." value="<?php isset($_SESSION['birth_place_mother'])  ?  print($_SESSION['birth_place_mother']) : ""; ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group label-floating">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Pekerjaan</label>
                                            <input type="text" class="form-control" name="mother_job" placeholder="Masukan Nama Pekerjaan..." value="<?php isset($_SESSION['mother_job'])  ?  print($_SESSION['mother_job']) : ""; ?>" required>
                                        </div>
                                    </div>
                                </div>
