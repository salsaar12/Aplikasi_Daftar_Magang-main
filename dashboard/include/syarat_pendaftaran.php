                ...
                <ol>
                    ...
                    <li>
                        ...
                        if ($upload_surat != "") {
                            ...
                            if ($daftar['status_pendaftaran'] == 1) {
                                echo '<font color="#2ecc71">a<i class="fa fa-check"></i></font>';
                            } else if ($daftar['status_pendaftaran'] >= 2) {
                                echo '<font color="#2ecc71">Upload Surat Pengantar Magang dari Sekolah/Perguruan Tinggi<i class="fa fa-check"></i></font>';
                            } else {
                                echo '<font color="#2ecc71">Upload Surat Pengantar Magang dari Sekolah/Perguruan Tinggi<i class="fa fa-check"></i></font> <a href="index.php?page=5" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-pencil"></i></a>';
                            }
                        } else {
                            echo 'Upload Surat Pengantar Magang dari Sekolah/Perguruan Tinggi <a href="index.php?page=5" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-upload"></i></a>';
                        }
                    ...
                    <li>
                        ...
                        if ($upload_foto != "") {
                            ...
                            if ($daftar['status_pendaftaran'] == 1) {
                                echo '<font color="#2ecc71">Pas Foto<i class="fa fa-check"></i></font>';
                            } else if ($daftar['status_pendaftaran'] >= 2) {
                                echo '<font color="#2ecc71">Pas Foto<i class="fa fa-check"></i></font>';
                            } else {
                                echo '<font color="#2ecc71">Pas Foto<i class="fa fa-check"></i></font> <a href="index.php?page=6" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-pencil"></i></a>';
                            }
                        } else {
                            echo 'Upload Pas Foto <a href="index.php?page=6" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-upload"></i></a>';
                        }
